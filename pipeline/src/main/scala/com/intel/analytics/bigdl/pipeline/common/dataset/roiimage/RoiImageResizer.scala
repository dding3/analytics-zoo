...
class RoiImageResizer(scales: Array[Int], scaleMultipleOf: Int = 1, resizeRois: Boolean = false,
  maxSize: Float = 1000f, isEqualResize: Boolean = false)
...
object RoiImageResizer {
  def apply(scales: Array[Int], scaleMultipleOf: Int = 1, resizeRois: Boolean = false,
    maxSize: Float = 1000f, isEqualResize: Boolean = false): RoiImageResizer =
    new RoiImageResizer(scales, scaleMultipleOf, resizeRois, maxSize, isEqualResize)
}

...
import pipeline.ssd.caffe.Caffe.{LayerParameter, NetParameter, V1LayerParameter}
...
class CaffeLoader[T: ClassTag](prototxtPath: String, modelPath: String,
  ...
  private var netparam: pipeline.ssd.caffe.Caffe.NetParameter = _
  private var name2LayerV1: Map[String, pipeline.ssd.caffe.Caffe.V1LayerParameter] = _
  private var name2LayerV2: Map[String, pipeline.ssd.caffe.Caffe.LayerParameter] = _
  ...
  private def loadBinary(prototxtPath: String, modelPath: String): pipeline.ssd.caffe.Caffe.NetParameter = {
  ...
  private def getBlob(name: String, ind: Int): Option[pipeline.ssd.caffe.Caffe.BlobProto] = {

...
if __name__ == "__main__":
    input_data = torch.randn(20, 320, 2) #batch_size=20 in_channel=2 Length=1000
    net = TemporalConvNet(past_seq_len=320, feature_num=2, future_seq_len=40, num_channels=[128,128,2])
    print(net)
